<template>
  <div class="bubble" :class="[ type, size, orientation, { 'is-visible': visible } ]">
    ...
    <nav class="bubble-nav" v-if="prev || next">
      <button v-on:click="playClick" @click="$emit('prev')" v-if="prev" style="margin-right: .5rem;">
      ...
      <button v-on:click="playClick" @click="$emit('next')" v-if="next" style="margin-left: auto;">
        Weiter
